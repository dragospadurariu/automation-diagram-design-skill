...
repository does not currently publish versioned releases, so older commits and
forks are not maintained as separate security-support channels.

## Report a vulnerability privately

Please use [GitHub private vulnerability reporting](https://github.com/dragospadurariu/automation-diagram-design-skill/security/advisories/new).
...
Thank you for helping keep Automation Design and its users safe.
