...
MOTION_TEMPLATE = ROOT / "skills/automation-design/assets/template-motion.html"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="lint-a11y-") as temp_dir:
        ...
        (project / "skills/automation-design/assets").mkdir(parents=True)
        (project / "skills/automation-design/references").mkdir(parents=True)
        shutil.copy2(LINTER, project / "scripts/lint-skin.py")
        shutil.copy2(
            ROOT / "skills/automation-design/references/style-guide.md",
            project / "skills/automation-design/references/style-guide.md",
        )
        project_style = project / "skills/automation-design/references/style-guide.md"
        ...
        (project / "skills/automation-design/assets/example-baseline.html").write_text(
        ...
        (project / "skills/automation-design/assets/template.html").write_text(
