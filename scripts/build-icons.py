"""Fetch and normalize the icon set for the automation-design skill.
...
so they inherit ink from context, and emits two artifacts:
  ...
  - skills/automation-design/references/primitive-icons.md  (catalog with snippets)
  - skills/automation-design/assets/icons.html               (visual gallery)
...
MD_OUT = REPO / "skills" / "automation-design" / "references" / "primitive-icons.md"
HTML_OUT = REPO / "skills" / "automation-design" / "assets" / "icons.html"
...
def fetch(url: str) -> str | None:
    try:
        req = urllib.request.Request(
            url, headers={"User-Agent": "automation-design-build/1.0 (https://github.com)"}
        )
...
<head>
  ...
  <title>Icon library · Automation Design</title>
...
<body>
  <div class="container">
    <div class="header">
      <p class="eyebrow">Icons · Automation Design</p>
      <h1>Icon library</h1>
