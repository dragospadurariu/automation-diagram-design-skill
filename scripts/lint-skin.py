...
STYLE_GUIDE = ROOT / "skills/automation-design/references/style-guide.md"
...
def parse_args():
    ...
    parser.add_argument(
        "--all",
        action="store_true",
        help="lint every skills/automation-design/assets/example-*.html and template*.html file",
    )
    parser.add_argument(
        "--baseline",
        action="store_true",
