...
Redraw the Mermaid source at `$1` in this skill's design system, following [`skills/automation-design/references/import-mermaid.md`](../skills/automation-design/references/import-mermaid.md) and [`skills/automation-design/references/output-spec.md`](../skills/automation-design/references/output-spec.md). Treat those references as the source of truth.
...
- Type is chosen from the extracted grammar and structure; `--type` forces one of the 11.
