...
- Border between layers: 1px hairline `rgba(30,30,30,0.12)`. Outer silhouette 1px ink or muted.
...
- Mint on **one** focal layer (stroke + subtle tint fill) — the bottleneck, the pay-rent layer, the one under discussion.
