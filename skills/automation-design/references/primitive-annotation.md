...
<text x="904" y="36" fill="#1e1e1e" font-size="14" font-style="italic"
...
<path d="M 820 44 Q 700 84 520 216" fill="none"
      stroke="rgba(30,30,30,0.40)" stroke-width="1" stroke-dasharray="4,3"/>
<!-- 3. Landing dot -->
<circle cx="520" cy="216" r="2" fill="#1e1e1e"/>
```
...
| Intent | Text | Leader |
|---|---|---|
| Neutral aside | ink `#1e1e1e` | `rgba(30,30,30,0.40)` |
| Focal / accent | mint `#087a5b` | `rgba(8,122,91,0.50)` |
| Tertiary (muted) | muted `#4a5464` | `rgba(30,30,30,0.30)` |
